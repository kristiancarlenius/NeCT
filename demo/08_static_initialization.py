...
reconstruction_path_dynamic, _ = nect.reconstruct(
    ...
    static_init = "/cluster/home/kristiac/NeCT/outputs/static_init/hash_grid_21_4_21_16_2_4_128_L1/bentheimer_05/model/checkpoints/last.ckpt", #str(Path(output_path) / "/model/checkpoints/last.ckpt"),#
    static_init_config= "/cluster/home/kristiac/NeCT/outputs/static_init/hash_grid_21_4_21_16_2_4_128_L1/bentheimer_05/model/config.yaml", #str(Path(output_path) / "/model/config.yaml"),#"/cluster/home/kristiac/NeCT/outputs/static_init/hash_grid_21_4_21_16_2_4_128_L1/bentheimer_15/model/config.yaml", #
    config_override={
        "epochs": "5x",
        "checkpoint_interval": 0,
        "image_interval": 00,
