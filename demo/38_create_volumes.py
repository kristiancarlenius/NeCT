...
print(nect.export_volumes(base_path="/cluster/home/kristiac/NeCT/outputs/dynamic_non/quadcubes_21_4_21_16_2_4_128_L1/2025-10-16T23-15-10/model/", binning=5, ROIx=[300, 1200], ROIy=[300, 1200], ROIz=[300, 1200], timesteps_per_revolution=1, export_revolutions=[0, 1, 2, 3, 4, 6, 8]))
# 
"""
