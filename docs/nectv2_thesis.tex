...
\todo{Add a high-level overview figure to the Introduction showing the two parts of the thesis (encoder optimisation and continuous scanning) and their relationship to the NeCT baseline. The figure should make the structure of contributions immediately clear to a reader scanning the chapter.}
...
\todo{Add a figure illustrating the hybrid golden-section sampling scheme: show the sample stage, the angular positions of successive revolutions, and how the golden offset distributes projections across revolutions. A comic-strip style with one panel per revolution showing the evolving angular coverage would work well.}
...
\todo{Add a figure here illustrating the three governing phenomena: collision rate, frequency coverage, and spatial-temporal asymmetry. Each panel should show the key variable being manipulated and its effect on the encoder.}
