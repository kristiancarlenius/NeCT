...
\begin{figure}[H]
    ...
    \caption{Network block for static reconstruction model unsing one encoder and MLP.}
...
\begin{figure}[H]
    ...
    \caption{The NeCT QuadCubes architecture. Four independent 3D multiresolution hash encoders concatenatinating the feature vectors are decoded by a shared MLP.}
...
\todo{cant say anything, vary too wildely, need avg of multiple runs or datasets or both to reduce randomness in results.}
