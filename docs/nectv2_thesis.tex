...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{nerf.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.82\textwidth]{quadcubes.png}
    \caption{The NeCT QuadCubes architecture. Four independent 3D multiresolution hash encoders cover all four 3-element subsets of the space-time coordinates $\{x,y,z,t\}$. Their concatenated feature vectors are decoded by a shared MLP to produce the attenuation coefficient $\hat{\mu}(\mathbf{r},t)$.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\textwidth]{equalized_psnr.png}
