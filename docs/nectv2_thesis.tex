...
\textbf{\MixedCubes{} architecture.} Replacing the hashed 2D temporal encoders with fully dense 2D grids eliminates hash collisions in the temporal encoders and achieves the best reconstruction quality of any architecture tested at the 24-hour wall-clock mark. The best \MixedCubes{} configuration achieves 37.73\,dB PSNR at 24 hours at 22.1\,GB GPU memory — the highest quality at 24\,h of any architecture evaluated, achieved at the lowest VRAM among the top-performing configurations. This places \MixedCubes{} as the best overall choice when balancing reconstruction quality, memory consumption, and training time: it leads at the practical wall-clock comparison point at roughly half the baseline VRAM. A lightweight variant reaches within 0.08\,dB of the QuadCubes baseline at 5.1\,GB, approximately 11\% of the original memory requirement, making \NeCTv{} accessible for all CUDA-compatible consumer GPUs for the first time.
