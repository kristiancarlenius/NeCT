...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/100_ac1.png}
        \caption{100-proj, $K=1$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
        \caption{Ground truth (1400-proj, $K=1$)}
    \end{subfigure}
    \vspace{0.5em}

    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/100_ac2.png}
        \caption{100-proj, $K=2$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
    ...
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/100_ac3.png}
        \caption{100-proj, $K=3$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
    ...
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/100_ac4.png}
        \caption{100-proj, $K=4$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
    ...
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/100_ac6.png}
        \caption{100-proj, $K=6$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.46\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
        \caption{Ground truth (1400-proj, $K=1$)}
    \end{subfigure}
    \caption{Reconstruction slice comparisons for the 100-projection continuous-scan configuration ($\Delta\phi = 3.60\degree$). Each row shows the continuous-scan reconstruction at accumulation steps $K \in \{1, 2, 3, 4, 6\}$ (left) alongside the 1400-projection step-and-shoot ground truth (right). The improvement in edge sharpness and pore fidelity with increasing $K$ is visible in the coarser acquisition.}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/360_ac1.png}
        \caption{360-proj, $K=1$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/360_ac2.png}
        \caption{360-proj, $K=2$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/360_ac3.png}
        \caption{360-proj, $K=3$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/360_ac4.png}
        \caption{360-proj, $K=4$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/360_ac6.png}
        \caption{360-proj, $K=6$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{images/1400_ac1.png}
        \caption{Ground truth (1400-proj, $K=1$)}
    \end{subfigure}
    \caption{Reconstruction slice comparisons for the 360-projection continuous-scan configuration ($\Delta\phi = 1.00\degree$). Each row shows the continuous-scan reconstruction at accumulation steps $K \in \{1, 2, 3, 4, 6\}$ (left) alongside the 1400-projection step-and-shoot ground truth (right). The improvement in edge sharpness and pore fidelity with increasing $K$ is visible in the coarser acquisition.}
